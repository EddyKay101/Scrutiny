...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
                ...
                <img height="170" width="170" class="logo_name" src="<?php echo base_url(); ?>public/img/scrut3.svg"/>
            <h3>Welcome to Scrutiny Admin Section</h3>
            <p>Where music matters/
                
            </p>
            <p>Login In Below.</p>
            <form id="login_form" class="m-t" role="form" method="post" action="<?=site_url('admin/user/login')?>">
