        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="text-center">
                    <img src="<?php echo base_url();?>/public/user_img/<?php echo $img;?>" class="img-circle"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" type="text" name="firstname"
                                value="<?php echo $members['firstname']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" type="text" name="lastname"
                                value="<?php echo $members['lastname']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" type="text" name="username"
                                value="<?php echo $members['username']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" type="text" name="location"
                                value="<?php echo $members['Location']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <textarea class="form-control" type="text"
                                name="info"><?php echo $members['info']; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" type="password" name="password"
                                value="<?php echo $members['password']; ?>"">
            </div>
          </div>
          <div class=" form-group">
    ...
    <div class=" form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input class="button rounded-item" type="submit" value="Submit">
                                </div>
