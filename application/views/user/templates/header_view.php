    ...
    <header class="main-head">
        ...
        <nav id="navbar" class="scrutiny-light-background top">
			...
			c-0.4,12.6,1.5,24.5,7.1,35.7C-405.8,444.6-406,445.3-405.9,447z" />
                ...
                <div class="nav-links">
                    <ul class="main-menu">
                        <div class="nav-a scrutiny-light-text close-menu"><i class="fa fa-times"></i></div>
                        <li><a class="nav-a page-scroll scrutiny-light-text" href="#hero">Home</a></li>
                        <li><a class="nav-a page-scroll scrutiny-light-text" href="#reviews">Reviews</a></li>
                        <li><a class="nav-a page-scroll scrutiny-light-text" href="#sign-in">Connect</a></li>
                        <li><a class="nav-a page-scroll scrutiny-light-text" href="#contact">Contact</a></li>
...
?>
                        <li class="dropdown">
                            <a class="nav-a scrutiny-light-text dropdown-toggle count-info" data-toggle="dropdown"
                                href="#">
                        ...
                        <li><a class="nav-a scrutiny-light-text" href="<?=site_url('user/home/logout')?>"><i
...
?>
                        ...
                        <li>
                            <a class="nav-a scrutiny-light-text" data-toggle="modal" href="#modal-form">
...
?>
                    ...
                    <ul class="nav-icon-menu">
                        <li>
                            <div class="nav-a scrutiny-light-text open-menu"><i class="fa fa-bars"></i></div>
                        </li>
                    </ul>
                </div>
    ...
    <script type="text/javascript">
    let notification_count = "<?php echo $notification_count; ?>";
    let chat_count = "<?php echo $chat_count; ?>";
    const user_id = "<?php echo $user_id; ?>";
    </script>
    <script type="text/javascript">
    let notification = "<?php foreach ($notification as $notif) {
    echo $notif['username'];
}?>";
    </script>
    <script type="text/javascript">
