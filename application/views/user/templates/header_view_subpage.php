        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header page-scroll">
                    ...
                    <img height="90" width="120" src="<?php echo base_url(); ?>public/img/scrut3.svg" />
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right" id="navi">
                        <li <?php if ($this->uri->segment(2) == "home") {
                                echo 'class="active"';
                            } ?>><a class="page-scroll" href="<?php echo base_url(); ?>home">Home</a></li>
                        <li <?php if ($this->uri->segment(2) == "reviews") {
                                echo 'class="active"';
                            } ?>><a class="page-scroll" href="<?php echo base_url(); ?>reviews">Reviews</a></li>
                        <li <?php if ($this->uri->segment(2) == "videos") {
                                echo 'class="active"';
                            } ?>><a class="page-scroll" href="<?php echo base_url(); ?>videos">Videos</a></li>
                        <li <?php if ($this->uri->segment(2) == "artists") {
                                echo 'class="active"';
                            } ?>><a class="page-scroll" href="<?php echo base_url(); ?>artists">Featured Artists</a></li>
