                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div>
                            <div class="ibox-content no-padding border-left-right">
                                ...
                                <img alt="image" class="img-responsive" src="<?php echo base_url();?>/public/user_img/<?php echo $friends['media_img'];?>">
                            </div>
                            <div class="ibox-content profile-content">
                                <h4><strong><?php echo $friends['username'];?></strong></h4>
                                ...
                                <div class="row m-t-lg">
                                    <div class="col-md-4">
                                        <span class="bar">5,3,9,6,5,9,7,3,5,9</span>
