...
<div class="wrapper wrapper-content animated fadeInRight ecommerce">
            ...
            <?php 
             ...
             echo form_open_multipart('admin/mp3/insert');
           ?>
            ...
            <form>
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="title">Artist</label>
                            <input type="text" id="music_title" name="artist" value="" placeholder="Artist" class="form-control">
                        </div>
                    </div>
                    <br><br><br><br><br>
                    ...
                    <label class="control-label" for="title">Description:</label>
                                                   ...
                                                   <textarea style="width: 100%;" class="form-control" name="description"  placeholder="Add Body" id=""></textarea>
    ...
    <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a>
                                        ...
                                        <div class="col-sm-4">
                        <div class="form-group">
                            <label class="control-label" for="title">Upload Track</label>
                            <div class="fileinput fileinput-new input-group" data-provides="fileinput">
    <div class="form-control" data-trigger="fileinput">
        <i class="glyphicon glyphicon-file fileinput-exists"></i>
    <span class="fileinput-filename"></span>
