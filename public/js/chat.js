$(document).ready(function(){
	...
	$("a#submit_message").click(function(){
		...
		$.post(base_url +"user/chat/ajax_add_chat_message", { chat_id : chat_id, user_id : user_id, recipient : recipient, chat_message_content : chat_message_content }, function(data) {
